  ...
  return (
    <div>
      <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#f1f5f9', margin: 0 }}>Tariff Internet</h1>
      ...
      <div style={{ background: '#1e293b', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.06)', padding: '48px', textAlign: 'center' }}>
        ...
        <p style={{ color: '#475569', fontSize: '0.85rem', maxWidth: '360px', margin: '0 auto' }}>
          Modul <strong style={{ color: '#3b82f6' }}>Tariff Internet</strong> sedang kami kembangkan dan akan segera tersedia.
        </p>
